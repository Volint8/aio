...
const LoginPage = () => {
  ...
  const { login, adminSignupInit, adminSignupComplete } = useAuth();
  ...
  const modeLabel = useMemo(
    () => (mode === "login" ? "Welcome Back" : "Admin Sign Up"),
    [mode],
  );
    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-header">
          ...
          <p className="tagline">
            Organize <span aria-hidden="true">•</span> Track{" "}
            <span aria-hidden="true">•</span> Appraise
          </p>
        </div>
        ...
        <div className="auth-footer">
          ...
          <p style={{ marginTop: "12px", fontSize: "0.85em" }}>
            Need help?{" "}
            <a href="mailto:Hello@apraizal.com" className="link-button">
              Contact Support
            </a>
          </p>
        </div>
