...
const LandingPage = () => {
  return (
    <div className="landing-page" id="home">
      ...
      <main>
        <section className="landing-hero" aria-labelledby="landing-title">
          <div className="hero-content-wrapper">
            <h1 id="landing-title">
              Turn a year's worth of messy HR paperwork into a finished report
              with just one click.
            </h1>
            ...
            <div className="hero-actions">
              <Link to="/login?mode=admin_signup" className="cta cta-primary">
        ...
        <section id="features" className="landing-features-grid">
          <div className="landing-feature-card">
            ...
            <p>
              Keep all your team's tasks and objectives in one centralized
          ...
          <div className="landing-feature-card">
            ...
            <p>
              Align individual goals with organizational objectives to ensure
          ...
          <div className="landing-feature-card">
            ...
            <p>
              Automate performance reviews with data-driven insights and
      ...
      >
        &copy; {new Date().getFullYear()} Apraizal. All rights reserved.
      </footer>
    </div>
  );
};
