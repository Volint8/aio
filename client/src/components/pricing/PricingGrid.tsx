...
const tierOptions: TierOption[] = [
  ...
  },
  {
    ...
    users: 250,
    label: "250 users",
    prices: { NGN: { monthly: 25000, yearly: 300000 } },
  },
  {
    id: "tier-500",
    users: 500,
    label: "500 users",
    prices: { NGN: { monthly: 55000, yearly: 660000 } },
  },
  {
    id: "tier-1000",
    users: 1000,
    label: "1000 users",
    prices: { NGN: { monthly: 110000, yearly: 1320000 } },
  },
];
...
const PricingGrid: React.FC<PricingGridProps> = ({
  ...
  const debouncedHandleTierSelect = useDebouncedCallback(handleTierSelect, 800);
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      >
        ...
        <DebouncedButton
          onClick={() =>
            onPeriodChange(billingPeriod === "monthly" ? "yearly" : "monthly")
          }
          debounceMs={300}
          style={{
            position: "relative",
        ...
        {tierOptions.map((tier) => {
          ...
          return (
            <div
              ...
              onClick={() => debouncedHandleTierSelect(tier)}
              style={{
                padding: "24px",
                borderRadius: "12px",
                ...
                transition: "all 0.2s",
                transform:
                  hoveredTier === tier.id && !disabled && !isFree
                    ? "translateY(-4px)"
                    : "none",
                boxShadow:
                  hoveredTier === tier.id && !disabled && !isFree
